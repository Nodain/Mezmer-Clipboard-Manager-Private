...
export function IconPin({ size = 14, className, filled }: IconProps & { filled?: boolean }) {
  return (
    <svg
      width={size}
      height={size}
    ...
    >
      <path d="M12 22v-5" />
      <path
        d="M8.2 16h7.6c.9 0 1.4-1.1.7-1.8l-1.8-1.8a2 2 0 0 1-.6-1.4V7a2 2 0 0 0-2-2h-1.8a2 2 0 0 0-2 2v4c0 .5-.2 1-.6 1.4l-1.8 1.8c-.7.7-.2 1.8.7 1.8z"
...
export function IconMezmer({ size = 14, className }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
      ...
      className={className}
    >
      <path d="M12 3v6M12 15v6M5 8l4 4M15 12l4 4M5 16l4-4M15 8l4-4" />
    </svg>
  );
}
...
export function IconLink({ size = 14, className }: IconProps) {
  return (
    <svg
      ...
      className={className}
    >
      <path d="M10 14a4 4 0 0 1 0-5.5l1-1a4 4 0 0 1 5.5 0l1 1M14 10a4 4 0 0 1 0 5.5l-1 1a4 4 0 0 1-5.5 0l-1-1" />
    </svg>
  );
}
...
export function IconEyedropper({ size = 14, className }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
    ...
    >
      ...
      <path d="M14.5 5.5l4 4L9 19l-4 1 1-4 8.5-8.5z" />
      <path d="M16 4l4 4" />
    </svg>
  );
}
